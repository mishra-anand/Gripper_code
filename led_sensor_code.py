...
This code can be used to run a soft rigid test without needing the solenoids using the syringe
Steps:
...
import time
file_name = '/home/master/Desktop/demo.csv' #change this parameter
...
def get_sen_values():
    ...
    val2 = (s11.voltage + s10.voltage + s9.voltage + s8.voltage + s7.voltage)/5
    val3 = [s7.voltage, s8.voltage,s9.voltage,s10.voltage,s11.voltage]
    val4 = [s2.voltage, s3.voltage,s4.voltage,s5.voltage,s6.voltage]
    return val
